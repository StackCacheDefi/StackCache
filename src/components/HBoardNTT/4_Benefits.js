import STAR from "../../imgs/hboard-star-right.svg";
  ...
  return (
    <div className="w-full flex justify-center py-0 tablet:py-[100px]">
      <div className="relative text-white w-full laptop:w-[1024px] flex flex-col tablet:flex-row items-center justify-center py-[50px] px-[15px] laptop:px-0">
        ...
        <div className="font-sans items-center text-[32px] font-[300] p-0 laptop:pl-[100px] flex tablet:hidden mb-[20px]">
          Exclusive Benefits
        </div>
        <div>
        ...
        <div className="font-sans items-center text-[32px] font-[300] p-0 tablet:pl-[50px] laptop:pl-[100px] hidden tablet:flex">
          Exclusive Benefits
        </div>
      </div>
    </div>
