...
const LeftSideContainer = styled.div`
  ...
  align-items: center;
  padding-right: 50px;
  background: linear-gradient(180deg, #a5a6a5 0%, #737373 100.12%),
  ...
  return (
    <>
      <Container>
        <LeftSideContainer>
          <WhitepaperContainer>
            <Header>More on HBoard NTT’s</Header>
            <Description>
              Learn about the specifics and fully detailed information of the HBoard NTT
            </Description>
            <DownloadButtons>
              <a
                ...
                rel="noreferrer"
              >
                <Button>Download HBoard NTT Info</Button>
              </a>
            </DownloadButtons>
          </WhitepaperContainer>
        </LeftSideContainer>
