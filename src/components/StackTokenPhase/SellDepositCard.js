...
export default function SellDepositCard(props) {
  ...
  return (
    <div className="w-full tablet:w-[400px] flex flex-col-reverse items-center gap-[10px] py-[16px]">
      ...
      <div className="w-[90%] flex flex-col items-center">
        ...
        <input
          ...
          className={`mb-[15px] bg-transparent text-white border ${
            depositAmount != null && depositAmount < props.minValue
              ? "border-[#f00]"
              : "border-[#aaa]"
